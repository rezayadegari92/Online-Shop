...
from apps.orders.models import DiscountCode  # Importing DiscountCode model
from apps.products.models import Product  # Importing Product model
...
class Cart(models.Model):
    ...
    def from_dict(cls, data, user=None, session_key=None):
        ...
        cart, created = cls.objects.get_or_create(user=user, session_key=session_key)
        ...
        for item_data in data.get("items", []):
            try:
                ...
                CartItem.objects.create(
                    cart=cart, product=product, quantity=item_data["quantity"]
                )
