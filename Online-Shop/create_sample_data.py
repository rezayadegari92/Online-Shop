#!/usr/bin/env python
"""
Create sample data for testing the Online Shop API.
Run with: python manage.py shell < create_sample_data.py
Or: docker-compose exec web python create_sample_data.py
"""
...
def create_sample_data():
    ...
    phones = Category.objects.get_or_create(name="Smartphones", parent=electronics)[0]
    ...
    # Create brands
    apple = Brand.objects.get_or_create(name="Apple", website="https://apple.com")[0]
    ...
    lenovo = Brand.objects.get_or_create(name="Lenovo", website="https://lenovo.com")[0]
    nike = Brand.objects.get_or_create(name="Nike", website="https://nike.com")[0]
    adidas = Brand.objects.get_or_create(name="Adidas", website="https://adidas.com")[0]
    ...
    print(f"  - Clothing: {Product.objects.filter(category__parent=clothing).count()}")
    print(f"  - Discounted: {Product.objects.filter(discount_percent__gt=0).count()}")
    print("=" * 60)
    print("\n✅ Sample data created successfully!")
    print("\nTest the API:")
    print("  - http://localhost:8000/api/products/")
    print("  - http://localhost:8000/api/products/discounted/")
    print("  - http://localhost:8000/api/categories/")
    print("  - http://localhost:8000/api/brands/")
